...
export class Scene3D extends Sprite {
    ...
    _prepareSceneToRender() {
        ...
        var ambientProbe = this.ambientProbe || SphericalHarmonicsL2._default;
        //TODO:
    ...
    _parse(data, spriteMap) {
        ...
        var ambientProbeData = data.ambientProbe;
        if (ambientProbeData) {
            //TODO:
        }
        var reflectionProbeData = data.reflectionProbe;
...
Scene3D.AMBIENTPROBE = Shader3D.propertyNameToID("u_AmbientProbe");
