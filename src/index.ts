...
import { genVoxData } from "./datagen/TestData";
...
let sidelen=114;
let data = genVoxData(-2,2,sidelen,
	(x, y, z)=>{
...
let mesh = new MeshSprite3D(creatQuadMesh(mesh1.vertices, mesh1.faces));
scene.addChild(mesh);
mesh.transform.localPosition = new Vector3(-1,-1,-1)
debugger;
